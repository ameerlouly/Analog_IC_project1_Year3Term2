...
N 260 -160 280 -160 {lab=VOUT_LPF}
N 410 -160 430 -160 {lab=#net1}
N -80 -180 -60 -180 {lab=VOUT_BPF}
N 0 -180 20 -180 {lab=#net2}
N -60 170 -40 170 {lab=#net3}
N -60 100 -40 100 {lab=#net3}
N -40 100 -40 170 {lab=#net3}
N -40 100 30 100 {lab=#net3}
N -150 -180 -80 -180 {lab=VOUT_BPF}
N -40 10 -40 100 {lab=#net3}
N -10 10 120 10 {lab=#net3}
N -40 10 -10 10 {lab=#net3}
N -130 100 -120 100 {lab=VOUT_BPF}
N -130 -180 -130 100 {lab=VOUT_BPF}
N 180 10 290 10 {lab=VOUT_BSF}
N 270 10 270 120 {lab=VOUT_BSF}
N 350 10 360 10 {lab=#net1}
N 380 -160 380 10 {lab=#net1}
N 340 -160 410 -160 {lab=#net1}
N -250 -300 -130 -300 {lab=VOUT_BPF}
N -130 -300 -130 -180 {lab=VOUT_BPF}
N -400 -300 -310 -300 {lab=#net4}
N -400 -300 -400 -200 {lab=#net4}
N -420 -200 -390 -200 {lab=#net4}
N 10 -300 70 -300 {lab=#net2}
N 10 -300 10 -180 {lab=#net2}
N 130 -300 260 -300 {lab=VOUT_LPF}
N 260 -300 270 -300 {lab=VOUT_LPF}
N 270 -300 270 -160 {lab=VOUT_LPF}
N 360 10 380 10 {lab=#net1}
N 380 -240 380 -160 {lab=#net1}
N 380 -240 480 -240 {lab=#net1}
...
C {devices/code_shown.sym} -180 -620 0 0 {name=MODELS only_toplevel=true
